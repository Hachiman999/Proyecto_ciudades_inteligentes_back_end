...
const method_get = {
    ...
    avnall:async (req,res)=>{
      const data_pro = {
                    Longitud,Temperatura,Humedad,
                    Vel_viento,Temperatura_agua,Nivel_agua,
                    Caudal, Flujo, Punto_rocio, Presion,
                    Nubosidad,
                }; 
        ...
        for(var i =0; i< result.length; i++){
            ...
            data_pro.Longitud += Longitud; data_pro.Temperatura += Temperatura;  data_pro.Humedad +=Humedad; data_pro.Vel_viento+=Vel_viento; data_pro.Temperatura_agua += Temperatura_agua;
            data_pro.Nivel_agua += Nivel_agua; data_pro.Caudal += Caudal; data_pro.Flujo+= Flujo; data_pro.Punto_rocio+= Punto_rocio;data_pro.Presion +=Presion;data_pro.Nubosidad+=Nubosidad;     
